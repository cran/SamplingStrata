...
This dataframe is not explicitly required, as it is automatically produced from the *frame* dataframe by the *optimStrata* function. Norwithstanding, it is worth while to produce it in order to analyse the initial stratification of the frame, and what could be the associated sample size without optimization.
...
![](SamplingStrata_figures/optim1-1.png)

![](SamplingStrata_figures/optim1-2.png)

![](SamplingStrata_figures/optim1-3.png)
...
![](SamplingStrata_figures/initsol-1.png)

![](SamplingStrata_figures/initsol-2.png)

![](SamplingStrata_figures/initsol-3.png)
...
![](SamplingStrata_figures/optim2-1.png)

![](SamplingStrata_figures/optim2-2.png)

![](SamplingStrata_figures/optim2-3.png)
...
```{r init_sol3, eval=FALSE, echo=TRUE, results= FALSE, warning=FALSE}
set.seed(1234)
...
![](SamplingStrata_figures/init_sol3-1.png)

![](SamplingStrata_figures/init_sol3-2.png)

![](SamplingStrata_figures/init_sol3-3.png)

```{r init_sol3a, eval=FALSE, echo=TRUE, results= FALSE, warning=FALSE}
...
```{r init_sol4, eval=FALSE, echo=TRUE, warning=FALSE}
...
![](SamplingStrata_figures/optim3-1.png)

![](SamplingStrata_figures/optim3-2.png)

![](SamplingStrata_figures/optim3-3.png)
...
Once increased (or reduced) the sample size we can check what are the new expected CVs. With the second adjustment, that produced an increase of the total sample size, we obtain:
...
![](SamplingStrata_figures/optim4-1.png)

![](SamplingStrata_figures/optim4-2.png)

![](SamplingStrata_figures/optim4-3.png)
